...
class Mentor(models.Model):
    ...
    department_iitb = models.CharField(max_length=100, default="Civil")
    degree_iitb = models.CharField(max_length=100, default="BTech")
...
class ASMPProfile(models.Model):
    user = models.OneToOneField(User, on_delete=models.CASCADE)
    ...
    pref_1 = models.CharField(max_length=10, blank=True, null=True)
    pref_2 = models.CharField(max_length=10, blank=True, null=True)
    pref_3 = models.CharField(max_length=10, blank=True, null=True)
    pref_4 = models.CharField(max_length=10, blank=True, null=True)
    pref_5 = models.CharField(max_length=10, blank=True, null=True)
